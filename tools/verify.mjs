...
assert(fileContains("home_services_pro_app.jsx", /if \\(tab === \"home\" && getSupabaseConfig\\(\\)\\)[\\s\\S]*setAvailableJobs\\(\\[\\]\\)/m), "home_services_pro_app.jsx did not clear SIM seeds before loading when Supabase is configured");
