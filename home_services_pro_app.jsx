...
/* ══════════════════════════════════════════════════════════════════════
   HAVEN PRO — DESIGN TOKENS
   Approved green accent system is unchanged. Neutrals are now themed
   (light/dark) since Settings > Appearance is real in this slice.
   ══════════════════════════════════════════════════════════════════════ */
...
const LIGHT = {
  ...
  emTx: "#C2410C", emBg: "#FFF1EE", emBd: "#FFD4C7",
  dxTx: "#43536B", dxBg: "#EEF1F5", dxBd: "#D7DEE6",
  soonBg: "#EDEFEC",
};
const DARK = {
  bg: "#111815", w: "#1A2320", tx: "#EDF3EF", ts: "#9FB3AA", tm: "#5E7368", bd: "#293832",
  pg: "#34C48E", pgd: "#1C8A61", pgt: "#123B2C", pgb: "#22C55E",
  emTx: "#FF8A65", emBg: "#3A1F14", emBd: "#5C2E1C",
  dxTx: "#AEBBD1", dxBg: "#232B36", dxBd: "#333F4E",
  soonBg: "#22302B",
};
...
const SIM_JOBS = [
  ...
  { id: "j3", customerName: "Priya S.",  category: "Electrical",        title: "Outlet Repair",       payout: 150, inspectionFee: 40, distanceMi: 3.8, durationMin: 45, city: "Winter Park, FL", lat: 28.6021, lng: -81.3389, requested: "Today, 3:00 PM",    emergency: false, postedAt: Date.now() - 2 * 60 * 60 * 1000 },
  ...
  { id: "j8", customerName: "Robert K.",  category: "HVAC",              title: "AC Not Cooling",      payout: 220, inspectionFee: 55, distanceMi: 6.7, durationMin: 50, city: "Orlando, FL",     lat: 28.5310, lng: -81.3720, requested: "Today, 5:30 PM",    emergency: false, postedAt: Date.now() - 38 * 60 * 1000 },
  { id: "j9", customerName: "Angela F.",  category: "Appliance Repair",  title: "Dishwasher Repair",   payout: 140, inspectionFee: 35, distanceMi: 1.2, durationMin: 40, city: "Orlando, FL",     lat: 28.5395, lng: -81.3812, requested: "Tomorrow, 1:00 PM", emergency: false, postedAt: Date.now() - 4 * 60 * 1000 },
  { id: "j10", customerName: "Chris B.", category: "Plumbing",          title: "Faucet Install",      payout: 110, inspectionFee: 30, distanceMi: 4.9, durationMin: 30, city: "Orlando, FL",     lat: 28.5462, lng: -81.3898, requested: "Today, 11:00 AM",   emergency: false, postedAt: Date.now() - 26 * 60 * 60 * 1000 },
...
const DEFAULT_WORK_CATEGORIES = ["Plumbing", "Electrical", "HVAC", "Appliance Repair", "Handyman"];
...
const SIM_COMPLETED_JOBS = [
  ...
  { id: "c1", category: "Plumbing",          title: "Faucet Install",       city: "Orlando, FL",     requiresDiagnosis: true,  status: "complete",                payout: 110, inspectionFee: 30, tipAmount: 20, tipStatus: "paid",    materialsReimbursed: 0,  durationMin: 30, completedAt: dayOffsetThisWeek(1, 10) },
  ...
  { id: "c3", category: "Appliance Repair",  title: "Dishwasher Repair",    city: "Orlando, FL",     requiresDiagnosis: true,  status: "complete",                payout: 140, inspectionFee: 35, tipAmount: 15, tipStatus: "paid",    materialsReimbursed: 22, durationMin: 40, completedAt: dayOffsetThisWeek(2, 13) },
  { id: "c4", category: "HVAC",              title: "AC Not Cooling",       city: "Orlando, FL",     requiresDiagnosis: true,  status: "complete",                payout: 220, inspectionFee: 55, tipAmount: 30, tipStatus: "paid",    materialsReimbursed: 0,  durationMin: 50, completedAt: dayOffsetThisWeek(4, 9)  },
  ...
  { id: "c6", category: "Electrical",        title: "Outlet Repair",        city: "Winter Park, FL", requiresDiagnosis: true,  status: "inspection_completed", payout: 150, inspectionFee: 40, tipAmount: 0,  tipStatus: "notAdded", materialsReimbursed: 0,  durationMin: 20, completedAt: dayOffsetThisWeek(5, 11) },
  ...
  { id: "c11", category: "Electrical",        title: "Outlet Repair",       city: "Winter Park, FL", requiresDiagnosis: true,  status: "inspection_completed", payout: 150, inspectionFee: 40, tipAmount: 0,  tipStatus: "notAdded", materialsReimbursed: 0,  durationMin: 25, completedAt: daysAgo(18) },
  { id: "c12", category: "HVAC",              title: "AC Not Cooling",      city: "Orlando, FL",     requiresDiagnosis: true,  status: "complete",                payout: 220, inspectionFee: 55, tipAmount: 35, tipStatus: "paid",    materialsReimbursed: 18, durationMin: 55, completedAt: daysAgo(24) },
  ...
  { id: "c14", category: "Appliance Repair",  title: "Dishwasher Repair",   city: "Orlando, FL",     requiresDiagnosis: true,  status: "complete",                payout: 140, inspectionFee: 35, tipAmount: 0,  tipStatus: "notAdded", materialsReimbursed: 0,  durationMin: 45, completedAt: daysAgo(40) },
